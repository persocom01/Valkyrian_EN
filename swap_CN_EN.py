...
if __name__ == "__main__":
    ...
    swap_name("data/missions/chasingmemories/descriptor.json", "descriptor.json")
    swap_name("data/missions/chasingmemories/mission_text.txt", "mission_text.txt")
    swap_name("data/missions/chasingmemories/MissionDefinition.java", "MissionDefinition.java")
    swap_name("data/missions/kingsbane/descriptor.json", "descriptor.json")
    swap_name("data/missions/kingsbane/mission_text.txt", "mission_text.txt")
    swap_name("data/missions/kingsbane/MissionDefinition.java", "MissionDefinition.java")
    swap_name("data/missions/pastthestorm/descriptor.json", "descriptor.json")
    swap_name("data/missions/pastthestorm/mission_text.txt", "mission_text.txt")
    swap_name("data/missions/pastthestorm/MissionDefinition.java", "MissionDefinition.java")
    swap_name("data/missions/stardestroyer/descriptor.json", "descriptor.json")
    swap_name("data/missions/stardestroyer/mission_text.txt", "mission_text.txt")
    swap_name("data/missions/stardestroyer/MissionDefinition.java", "MissionDefinition.java")
    swap_name("data/missions/unexpectedtrouble/descriptor.json", "descriptor.json")
    swap_name("data/missions/unexpectedtrouble/mission_text.txt", "mission_text.txt")
